...
# **EXTRA w3d5 LAB**: LLM Serving Economics: Cost per Million Tokens & Scale-Out Analysis
...
| :---: | :---: | :---: | :---: | :---: |
| 1 | 462.1 | 1.419 | $0.2104 | Compliant |
| 2 | 858.8 | 1.601 | $0.1132 | Compliant |
| 4 | 1527.1 | 1.737 | $0.0637 | Compliant |
| 8 | 2357.0 | 1.804 | $0.0413 | Compliant |
| **16 (Knee)** | **3142.4** | **2.267** | **$0.0309** | **Compliant (Optimal)** |
...
| :---: | :---: | :---: | :---: | :---: |
| **1.0x** | 3142.4 | 1 | $0.35 | 2.267 |
| **1.5x** | 4713.6 | 2 | $0.70 | 2.267 |
| **2.0x** | 6284.8 | 2 | $0.70 | 2.267 |
| **3.0x** | 9427.2 | 3 | $1.05 | 2.267 |
...
* **Scale-Out Decision Model:** To absorb spikes exceeding knee capacity (3,142 tok/s), traffic must scale out across identical replicas running strictly at the safe knee concurrency. This preserves tail latency (`p95 = 2.267s`) across all replicas without risking queue saturation or thrashing.
